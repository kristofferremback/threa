...
const SheetOverlay = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Overlay>, SheetOverlayProps>(
  ({ className, skipAnimation, ...props }, ref) => (
...
const sheetVariantsBase = "fixed z-50 gap-4 bg-background p-6 shadow-lg"
const sheetVariantsAnimated =
...
const sheetVariants = cva(sheetVariantsBase, {
  variants: {
    side: {
...
const sheetAnimationVariants: Record<string, string> = {
...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, children, skipAnimation, ...props }, ref) => (
    <SheetPortal>
      <SheetOverlay skipAnimation={skipAnimation} />
      <SheetPrimitive.Content
        ref={ref}
        className={cn(
          sheetVariants({ side }),
          !skipAnimation && sheetVariantsAnimated,
          !skipAnimation && sheetAnimationVariants[side ?? "right"],
          className
        )}
        {...props}
      >
